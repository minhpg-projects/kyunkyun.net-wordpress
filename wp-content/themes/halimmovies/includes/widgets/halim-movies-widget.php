...
add_action( 'widgets_init', function () {
	register_widget( 'HaLim_Movies_Widget' );
} );


class HaLim_Movies_Widget extends WP_Widget {

	public function __construct() {
		parent::__construct(
			'halim-movies-widget',
			__( 'HaLim Movies Widget', 'halimthemes' ),
			array(
				'classname'   => 'halim-movies-widget',
				'description' => __( 'Display posts by movies', 'halimthemes' )
			)
		);
	}
	...
	public function widget( $args, $instance )
	{
		...
		<section id="halim-movies-widget-<?php echo $widget_id; ?>" class="halim-movies-widget-<?php echo $widget_id; ?>" style="position: relative;">
					...
					<div class="section-title">
						...
						<ul class="halim-popular-tab" role="tablist">
							...
							<li role="presentation"<?php echo 'latest' == $type ? ' class="active"' : ''; ?>>
								<a onclick="HaLim.GetPostByWidgetType('movies', '<?php echo $layout; ?>', <?php echo $postnum; ?>, 'latest', '<?php echo $widget_id; ?>');" role="tab" data-toggle="tab"><?php _e('Mới nhất', 'halimthemes') ?></a>
							</li>
							<li role="presentation"<?php echo 'lastupdate' == $type ? ' class="active"' : ''; ?>>
								<a onclick="HaLim.GetPostByWidgetType('movies', '<?php echo $layout; ?>', <?php echo $postnum; ?>, 'lastupdate', '<?php echo $widget_id; ?>');" role="tab" data-toggle="tab"><?php _e('Mới cập nhật', 'halimthemes') ?></a>
							</li>
							<li role="presentation"<?php echo 'mostview' == $type ? ' class="active"' : ''; ?>>
								<a onclick="HaLim.GetPostByWidgetType('movies', '<?php echo $layout; ?>', <?php echo $postnum; ?>, 'mostview', '<?php echo $widget_id; ?>');" role="tab" data-toggle="tab"><?php _e('Nhiều lượt xem', 'halimthemes') ?></a>
							</li>
			...
			<div class="halim_box" id="ajax-movies-widget-<?php echo $widget_id; ?>">
