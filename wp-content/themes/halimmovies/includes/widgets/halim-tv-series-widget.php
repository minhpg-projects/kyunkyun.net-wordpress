					...
					<div class="section-title">
						...
						<ul class="halim-popular-tab" role="tablist">
							...
							<li role="presentation"<?php echo 'latest' == $type ? ' class="active"' : ''; ?>>
								<a onclick="HaLim.GetPostByWidgetType('tv_series', '<?php echo $layout; ?>', <?php echo $postnum; ?>, 'latest', '<?php echo $widget_id; ?>');" role="tab" data-toggle="tab"><?php _e('Mới nhất', 'halimthemes') ?></a>
							</li>
							<li role="presentation"<?php echo 'lastupdate' == $type ? ' class="active"' : ''; ?>>
								<a onclick="HaLim.GetPostByWidgetType('tv_series', '<?php echo $layout; ?>', <?php echo $postnum; ?>, 'lastupdate', '<?php echo $widget_id; ?>');" role="tab" data-toggle="tab"><?php _e('Mới cập nhật', 'halimthemes') ?></a>
							</li>
							<li role="presentation"<?php echo 'mostview' == $type ? ' class="active"' : ''; ?>>
								<a onclick="HaLim.GetPostByWidgetType('tv_series', '<?php echo $layout; ?>', <?php echo $postnum; ?>, 'mostview', '<?php echo $widget_id; ?>');" role="tab" data-toggle="tab"><?php _e('Nhiều lượt xem', 'halimthemes') ?></a>
							</li>
