 ...
 */
function halim_add_filter( $hook, $function_name, $priority = 10, $accepted_args = NULL, $type = 'filter' ) {
	global $filters;
 ...
 */
function halim_add_action( $hook, $function_name, $priority = 10, $accepted_args = 1 ) {
	return halim_add_filter( $hook, $function_name, $priority, $accepted_args, 'action' );
}
 ...
 * @return mixed
 */
function halim_apply_filter( $hook, $value = '' ) {
	global $filters;
 ...
 * @return mixed
 */
function halim_apply_filters( $hook, $value = '' ) {
	return halim_apply_filter( $hook, $value );
}
 ...
 */
function halim_do_action( $hook, $arg = '' ) {
	global $actions;
...
*/
function halim_did_action( $hook ) {
	global $actions;
 ...
 */
function halim_remove_filter( $hook, $function_to_remove, $priority = 10, $accepted_args = 1 ) {
	global $filters;
 ...
 */
function halim_has_filter( $hook, $function_to_check = false ) {
	global $filters;
...
function halim_has_action( $hook, $function_to_check = false ) {
	return halim_has_filter( $hook, $function_to_check );
}
...
function halim_do_shortcode($text) {
	if(not_empty($text))	{
...
function halim_add_shortcode($short ='',$name ='' ) {
