...
class CSFramework_Option_upload extends CSFramework_Options {
  ...
  public function output() {
    ...
    // echo '<input type="text" name="'. $this->element_name() .'" value="'. preg_replace('/http(s?)\:\/\//i', '', $this->element_value()) .'"'. $this->element_class() . $this->element_attributes() .'/>';
    echo '<input type="text" name="'. $this->element_name() .'" value="'.str_replace(home_url(), '', $this->element_value()) .'"'. $this->element_class() . $this->element_attributes() .'/>';
